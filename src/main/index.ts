...
app.on('will-quit', (e) => {
  ...
  // Why: view-scoped CDP gateways hold localhost HTTP/WS servers. Close them
  // on quit so Playwright/Browser Use cannot keep a stale attach surface.
  void cdpViewGatewayManager.stopAll()
